...
r.glLine(0.5,-0.5,0.5,0.3)
r.glLine(0.5,0.3,-0.5,0.3)
r.glLine(-0.5,0.3,-0.5,-0.5)
r.glLine(-0.5,0.3,-0.8,0.25)
r.glLine(-0.5,-0.5,-0.8,-0.25)
r.glLine(-0.8,-0.25,-0.8,0.25)
r.glLine(0.7,0.3,-0.6,0.3)
r.glLine(0.7,0.3,0.2,0.9)
r.glLine(0.2,0.9,-0.7,0.3)
r.glLine(0.2,0.9,-0.6,0.6)
r.glLine(-0.7,0.3,-0.8,0.25)
r.glLine(-0.7,0.3,-0.8,0.3)
r.glLine(-0.6,0.6,-0.8,0.25)
r.glFinish("line.bmp")